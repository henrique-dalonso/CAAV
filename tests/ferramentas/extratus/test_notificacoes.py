...
def test_sucesso_do_robo_do_solicitante_vai_pra_minhas_e_e_descartavel(limpar_notificacoes_teste):
    # Henrique, 2026-09-02: quem pediu um relatório do Robô
    # (Job.solicitante_id) passa a ver o aviso só em "Minhas" — some de
    # "Ferramentas" pra essa pessoa, mas continua em "Ferramentas" (sem
    # X) pro resto do escritório.
    job = registrar_processado(
