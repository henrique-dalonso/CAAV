...
NOME_ADMIN_PLATAFORMA = "teste_custos_admin_plataforma"
NOME_ADMIN_SO_FERRAMENTA = "teste_custos_admin_ferramenta"
SENHA = "senhaTeste123"
...
def test_pagina_custos_exige_login():
    ...
    resp = cliente.get("/extratus/custos", follow_redirects=False)
...
def test_pagina_custos_admin_de_ferramenta_sem_ser_admin_plataforma_e_recusado(limpar_usuarios_teste):
    ...
    criar_usuario(
        nome="Teste Custos Admin Ferramenta",
        nome_usuario=NOME_ADMIN_SO_FERRAMENTA,
        email="teste_custos_admin_ferramenta@example.com",
        senha=SENHA,
        eh_admin=False,
    ...
    resp = cliente.get("/extratus/custos")
...
def test_pagina_custos_admin_da_plataforma_acessa(limpar_usuarios_teste):
    criar_usuario(
        nome="Teste Custos Admin Plataforma",
        nome_usuario=NOME_ADMIN_PLATAFORMA,
        email="teste_custos_admin_plataforma@example.com",
        senha=SENHA,
        eh_admin=True,
    )
