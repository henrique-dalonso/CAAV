...
def test_atualizar_config_robo_grava_pasta(preservar_config_json):
    atualizar_config_robo(pasta_entrada="uma/pasta/de/teste")
...
def test_atualizar_config_robo_rejeita_pasta_vazia(preservar_config_json):
    with pytest.raises(ValueError):
        atualizar_config_robo(pasta_entrada="   ")


def test_carregar_config_bruto_nao_resolve_caminho_absoluto(preservar_config_json):
    atualizar_config_robo(pasta_entrada="relativa/de/teste")
