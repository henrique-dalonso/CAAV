import app.core.env  # noqa: F401 — carrega o .env antes de qualquer coisa
...
from app.db.seed import garantir_ferramentas_padrao
from app.web.auth import NaoAutenticado
from app.web.routes import admin, auth, historico, home, inbox
