...
from app.ferramentas.extratus_aburesi.core.ia_cliente import gerar_relatorio_claude
from app.ferramentas.extratus_aburesi.core.relatorio_manager import salvar_relatorio_docx
from app.ferramentas.extratus_aburesi.core.output_manager import (
    gerar_caminho_unico,
    mover_para_erros,
    mover_por_confianca
)
from app.ferramentas.extratus_aburesi.core.nomeador_relatorio import gerar_nome_relatorio
from app.ferramentas.extratus_aburesi.db.jobs import registrar_processado, registrar_erro
...
def ajustar_confianca_pos_ia(confianca, uso_ia):
    """Ver docstring equivalente em app/ferramentas/extratus/core/pipeline.py
    (Extratus - Relatórios) — mesma lógica, reaproveitada por
    core/pipeline_manual.py deste módulo também."""
    motivos_revisao = []
