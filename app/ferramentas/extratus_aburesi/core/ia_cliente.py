...
# pedaço ainda carrega o prompt inteiro (cacheado) e precisa sobrar
# espaço pra resposta — prioriza nunca estourar contexto sobre economizar
# uma chamada a mais. Só usado no fluxo síncrono (fila manual) por
# enquanto — o Motor/Batch API não suporta uma sequência de chamadas
# dependentes dentro de um único item de lote, então processos grandes
# no Motor continuam caindo em erro claro, como hoje.
