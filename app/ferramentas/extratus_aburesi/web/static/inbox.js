(function () {
    ...
    // ---------------------------------------------------------------
    // Polling — GET /extratus-aburesi/estado a cada poucos segundos, igual em
    ...
    function preencherItemProcessando(li, item) {
        ...
        if (item.status === "concluido") {
            ...
            link.href = "/extratus-aburesi/relatorios?processo=" + encodeURIComponent(item.processo_detectado || "");
    ...
    function criarItemConferencia(item) {
        ...
        if (item.tipo === "duplicado_relatorio") {
            ...
            linkRelatorio.href = (item.link_relatorio || "/extratus-aburesi/relatorios") + "?processo=" + encodeURIComponent(item.processo_detectado || "");
        ...
        formAprovar.action = "/extratus-aburesi/conferencia/" + item.id + "/aprovar";
        ...
        formDescartar.action = "/extratus-aburesi/conferencia/" + item.id + "/descartar";
    ...
    document.addEventListener("click", function (evento) {
        ...
        fetch("/extratus-aburesi/processamento/" + id + "/descartar", { method: "POST" })
