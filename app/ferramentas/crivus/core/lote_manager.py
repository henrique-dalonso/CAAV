...
usada como entrada, só existe no export). As duas datas vêm como TEXTO
...
# está, sem limpeza prévia. As 2 datas viraram OBRIGATÓRIAS nesta rodada
# (2026-09-14): alimentam o harness de urgência/"adiantado" em
# lote_batch.py, não são só informativas como antes.
COLUNAS_OBRIGATORIAS = ["NPJUR", "DATA DA PUBLICAÇÃO", "DATA DA IMPORTAÇÃO DA PUBLICAÇÃO", "TEOR PUBLICAÇÃO"]
...
def ler_linhas_planilha(caminho):
    ...
    indice_data_importacao = mapa["DATA DA IMPORTAÇÃO DA PUBLICAÇÃO"]
