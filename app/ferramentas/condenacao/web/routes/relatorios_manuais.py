...
router = APIRouter(dependencies=[Depends(exigir_acesso_manual("condenacao"))])
...
def _redirecionar(erro=None, sucesso=None):
    ...
    return RedirectResponse(url=f"/condenacao/relatorios-urgentes{query}", status_code=303)
